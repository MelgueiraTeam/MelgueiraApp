...
import 'package:melgueira_app/telas/grafico_tempo_real/melgueiraRealTime.dart';
import 'package:melgueira_app/telas/grafico_tempo_real/ninhoRealTime.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          body: TabBarView(
            children: [
              MelgueiraRealTime(atualizaCarrregamento),
